  ...
  try {
    ...
    for (let i = 0; i < 50; i++) {
      ...
      tokenLogs.push({
        ...
        date: randomDate,
        tokensUsed,
        cost: Math.round((tokensUsed / 1000) * tokenCostPer1K * 10000) / 10000,
    ...
    const invoices = [
      {
        ...
        metadata: {
          tokenUsage: 75000,
          billingPeriod: { start: new Date('2024-03-01'), end: new Date('2024-03-31') }
        }
      },
      {
        invoiceId: crypto.randomUUID(),
        ...
        metadata: {
          tokenUsage: 100250,
          billingPeriod: { start: new Date('2024-04-01'), end: new Date('2024-04-30') }
        }
      },
      {
        invoiceId: crypto.randomUUID(),
